  ...
  <aside class="h-15 w-full bg-neutral-700 fixed top-0  right-0 flex justify-between items-center z-1000">
    <div class="pl-5" >
      ...
      <div class="text-center">
        <button class="text-white hover:bg-neutral-700  font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-neutral-700 focus:outline-none " type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
      ...
      <!-- drawer component -->
      <div id="drawer-navigation" class="fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full  bg-white dark:bg-neutral-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
